...
def main():
    ...
    save_csv_path = os.path.join(script_dir, "realtime_cnn_classifier_log.csv")
    ...
    print("=== Realtime CNN Classifier Performance Test ===")
    ...
    model = SimpleCNN(num_classes=num_classes, c_in=c_in).to(device)
